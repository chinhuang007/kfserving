...
class FeastTransformer(kfserving.KFModel):
    """ A class object for extracting features from Feast online store
    and returning a KFServing compatible response.
    ...
    def preprocess(self, inputs: Dict) -> Dict:
        """Pre-process activity of the Input data.
